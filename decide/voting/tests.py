...
class VotingModelTC(BaseTestCase): 
    def setUp(self): 
        ...
        # el siguiente es un objeto de la clase, no del metodo
    ...
    def testExit(self):
        self.v=Voting.objects.get(name='Votacion')
        self.assertEquals(self.v.question.options.all()[0].option , 'option1')
        self.assertEquals(self.v.question.options.all()[1].option , 'option2') 
        self.assertEquals(len(self.v.question.options.all()) , 2)
    ...
    def testCreatingVotingApi(self): 
        ...
        self.v=Voting.objects.get(name='Example') 
        self.assertEquals(self.v.desc , 'Descripcion')
